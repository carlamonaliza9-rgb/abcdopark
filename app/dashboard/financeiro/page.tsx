...
export default function FinanceiroPage() {
  ...
  async function carregarDados() {
    ...
    try {
      ...
      // NOVO: Busca as contas pagas no mês atual da nova tabela
      ...
      // NOVO: Une os gastos avulsos com as contas a pagar para aparecerem na lista detalhada
      ...
      // NOVO: Soma os gastos avulsos (modal) E as contas a pagar no total de gastos dos cards
