...
import { ModalAgendaTurma } from "./_components/ModalAgendaTurma"; // Novo componente importado
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '25px' }}>
        {turmas.map((turma) => (
          <TurmaCard
            ...
            onAbrirAgenda={(e, t) => { e.stopPropagation(); setTurmaParaAgenda(t); setModalAgendaAberto(true); }} // Lógica de agenda vinculada
          />
        ))}
      </div>
