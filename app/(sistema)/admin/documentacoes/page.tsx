...
export default function DocumentacoesAdminPage() {
  ...
  if (verificandoAcesso) {
    return (
      <div className="p-12 text-center text-slate-500 font-medium w-full">
          ...
          <div className="w-full animate-in fade-in duration-300">
            ...
            <div className="w-full">
              ...
              {documentoAtivo === "codes" && (
                <PainelCodes alunos={alunos} />
              )}

              {/* HISTÓRICO EXISTENTE */}
              {documentoAtivo === "historico" && (
                <PainelHistoricoEscolar />
              )}

              {/* NOVO HISTÓRICO ESCOLAR */}
              {documentoAtivo === "historico-escolar" && (
                <PainelHistoricoEscolar />
              )}
              ...
              {[
                ...
                "ressalva",
                "notificacao",
              ].includes(documentoAtivo) && (
                <PainelDocumentosGerais
                  alunos={alunos}
                  documentoAtivo={documentoAtivo}
                />
              )}

              {/* DIAGNÓSTICO: se nenhum painel corresponder */}
              {![
                "comunicados",
                "provas",
                "codes",
                ...
                <div className="bg-white rounded-3xl border border-red-200 p-8">
                  ...
                  <div className="mt-4 bg-slate-100 rounded-xl p-4 font-mono font-bold">
                    documentoAtivo = {documentoAtivo}
                  </div>
                </div>
              )}
