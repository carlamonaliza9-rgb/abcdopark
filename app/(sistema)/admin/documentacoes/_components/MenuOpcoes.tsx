  ...
  return (
    <div className="w-full h-full flex flex-col animate-in fade-in duration-500">
      ...
      <div className="w-full mt-auto bg-white border border-slate-200 rounded-[1.5rem] p-5 md:px-8 flex flex-col md:flex-row items-center justify-between gap-4 shadow-sm">
        ...
        <button 
          onClick={() => setDocumentoAtivo('historico')}
          className="w-full md:w-auto flex items-center justify-center gap-2 bg-white border border-slate-200 hover:bg-slate-50 text-blue-600 px-6 py-3.5 rounded-xl text-[11px] font-black uppercase tracking-widest shadow-sm transition-colors shrink-0"
        >
