...
import { Users, BookOpen, CalendarDays, MoreVertical, FileText } from "lucide-react";
...
interface TurmaCardProps {
  ...
  onAbrirAvancosDificuldades: (e: React.MouseEvent, turma: any) => void;
}
    ...
    >
      ...
      <div className="relative z-10 flex justify-between items-center mt-4 pt-4 border-t border-slate-800/5">
        ...
        <div className="flex gap-1">
          {[
            { icon: <FileText size={13} strokeWidth={2.5} />, action: onAbrirAvancosDificuldades, arg: turma, title: "Avanços e Dificuldades" },
